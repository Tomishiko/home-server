export class FileUploader {
    ...
    private async StreamFile(file: File, progressBar: JQuery) {
        ...
        try {
            ...
            const response = await fetch("api/streaming/handshake",
                {
                    method: "POST",
                    headers: {
        ...
        async function PostData(link: string, data: FormData) {
    ...
    private NewProgresBar(fname: string, id: number) {
